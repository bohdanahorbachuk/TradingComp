...
namespace DAL.Tests
{
    ...
    public class SupplyDalTests
    {
        ...
        {
            dal = new SupplyDAL(ConfigurationManager.ConnectionStrings["TC"].ConnectionString);
        }
        ...
        public void GetAllSupplyTest()
        {
            ...
            Assert.IsTrue(supply.Any(s => s.PersonID == 1005));
            Assert.IsTrue(supply.Any(s => s.CategoryID == 1002));
